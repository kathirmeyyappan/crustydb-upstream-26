...
pub use translate_and_validate::get_attr;
pub use translate_and_validate::Translator;
mod executor;
// pub mod planner0;
pub mod planner;
pub mod translate_and_validate;
...
mod test {
    ...
    mod integration {
        ...
        fn test_group_by() {
            ...
            let expected = vec![
                vec![Field::Int(1), Field::Int(3), Field::Int(6)],
                vec![Field::Int(2), Field::Int(3), Field::Int(15)],
            ];
