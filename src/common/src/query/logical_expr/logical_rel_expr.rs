    ...
    pub fn to_physical_plan(&self) -> PhysicalRelExpr {
        match self {
            ...
            Self::Join {
                ...
                // TODO: see https://github.com/rotaki/query_exec/blob/725a83aaf8d9c9504b1e37355b01e87e580bf107/src/expression/physical/mod.rs#L599
                // and https://github.com/rotaki/query_exec/blob/725a83aaf8d9c9504b1e37355b01e87e580bf107/src/executor/volcano/mod.rs#L717
                ...
                //debug!("Translating join predicates: {:?}", predicates);
